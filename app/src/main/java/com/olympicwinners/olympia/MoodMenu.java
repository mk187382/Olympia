...
public class MoodMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mood_menu);
    ...
    public void openMoodChoice(View view) {
    ...
    public void openAbout(View view) {
        Intent myIntent = new Intent(MoodMenu.this, AboutOlympia.class);
        MoodMenu.this.startActivity(myIntent);
    }
    ...
    public Action getIndexApiAction() {
        Thing object = new Thing.Builder()
                .setName("MoodMenu Page") // TODO: Define a title for the content shown.
